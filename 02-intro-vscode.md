...
- [Eclipse](https://eclipseide.org/) – often used for Java and other compiled languages
- [JupyterLab](https://jupyter.org/) – interactive environment for Python and data science
